...
mod tests {
    ...
    fn test_multi_scope_isolation() {
        ...
        let global_facts = engine.query_facts_in_scope("praveen", &ContextScope::Global, 1050);
        assert_eq!(global_facts.len(), 1);
        assert_eq!(global_facts[0].claim, "English");

        let global_view = engine.resolve_scope("praveen", &ContextScope::Global, 1050);
        ...
        let health_view =
            engine.resolve_scope("praveen", &ContextScope::Domain(DomainKind::Health), 1050);
        ...
        let sarah_view = engine.resolve_scope("praveen", &sarah_scope, 1050);
        ...
        let sarah_facts = engine.query_facts_in_scope("praveen", &sarah_scope, 1050);
        ...
        let alok_facts = engine.query_facts_in_scope("praveen", &alok_scope, 1050);
    ...
    fn test_epistemic_conflict_blocks_inference_from_overwriting_ground_truth() {
        ...
        let active_facts = engine.query_facts_in_scope("praveen", &work_scope, 1050);
    ...
    fn test_explicit_supersession_preserves_temporal_history() {
        ...
        let past_view = engine.resolve_scope("praveen", &alok_scope, 1500);
        ...
        let current_view = engine.resolve_scope("praveen", &alok_scope, 2500);
    ...
    fn test_provenance_tracking_and_hlc_window() {
        ...
        let prov = engine.get_provenance("praveen", "fact_prov_1").unwrap();
