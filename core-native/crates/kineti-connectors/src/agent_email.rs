...
pub struct InboundAgentEmail {
    ...
    /// Sender address.
    pub from: String,
    /// Recipient address (e.g. `alex+amazon_1a2b@mail.kineti.com`).
    pub to: String,
    /// Subject line.
    pub subject: String,
...
mod tests {
    ...
    fn test_agent_email_alias_generation() {
        ...
        let alias = client.generate_alias("alex", "amazon");
        assert!(alias.starts_with("alex+amazon_"));
